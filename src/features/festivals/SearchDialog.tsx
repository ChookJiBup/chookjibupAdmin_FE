  ...
  return (
    ...
    >
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 z-[1001] w-[480px] max-w-[calc(100vw-32px)] max-h-[calc(100dvh-32px)] overflow-y-auto -translate-x-1/2 -translate-y-1/2 rounded-2xl bg-white p-5 sm:p-8">
